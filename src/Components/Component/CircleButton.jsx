            ...
            <div className="card shadow mb-4">
                ...
                <div className="card-body">
                        ...
                        buttonsData.map((item) => {
                            return (
                                <a href="#" className={`btn btn-${item.color} btn-circle mr-1`}>
                                    <i className={`${item.icon == 'facebook-f' ? 'fab' : 'fas'} fa-${item.icon}`}></i>
                                </a>
                            )
                        })
                    }
                    ...
                    </div>
                    {
                        buttonsData.map((item) => {
                            return (
                                <a href="#" className={`btn btn-${item.color} btn-circle btn-sm mr-1`}>
                                    <i className={`${item.icon == 'facebook-f' ? 'fab' : 'fas'} fa-${item.icon}`}></i>
                                </a>
                            )
                        })
                    ...
                    </div>
                    {
                        buttonsData.map((item) => {
                            return (
                                <a href="#" className={`btn btn-${item.color} btn-circle btn-lg mr-1`}>
                                    <i className={`${item.icon == 'facebook-f' ? 'fab' : 'fas'} fa-${item.icon}`}></i>
                                </a>
                            )
                        })
